...
class TestCreateUser {
    ...
    final void testCreateUser() {
        ...
        shippingAddress.put("city", "Daegu");
        shippingAddress.put("country", "South-Korea");
        shippingAddress.put("streetName", "123 Street name");
        shippingAddress.put("postalCode", "123456");
        shippingAddress.put("type", "shipping");

        Map<String, Object> billingAddress = new HashMap<>();
        billingAddress.put("city", "Daegu");
        billingAddress.put("country", "South-Korea");
        ...
        userDetails.put("firstName", "Jacob");
